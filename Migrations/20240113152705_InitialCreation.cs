        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PasswordHash = table.Column<string>(type: "NVARCHAR(180)", maxLength: 180, nullable: false),
                    LastLoggedIn = table.Column<DateTime>(type: "DATE", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
